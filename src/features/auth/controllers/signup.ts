...
export class SignUp{
  ...
  public async create(req: Request, res: Response): Promise<void>{
    ...
    const result: UploadApiResponse = await uploads(avatarImage, `${userObjectId}`, true) as UploadApiResponse;
    ...
    userDataForCache.profilePicture = `https//res.cloudinary.com/dwwbbptjw/image/upload/v${result.version}/${userObjectId}`;
